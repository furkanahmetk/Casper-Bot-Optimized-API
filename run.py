...
if __name__ == '__main__':
    ...
    task = Repeated_Task()
    scheduler.add_job(id = '1', func = task.data_cron, trigger = 'interval', seconds = 30, max_instances=5)
    scheduler.add_job(id = '2', func = task.metrics_cron, trigger = 'interval', seconds = 30, max_instances=5)
    scheduler.start()
